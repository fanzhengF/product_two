...
class Emojione {
    ...
    static function toBlank($string)
    {
        $search = array_keys(self::$unicode_replace);
        return str_replace($search, '', $string);
    	// return preg_replace_callback('/'.self::$ignoredRegexp.'|'.self::$unicodeRegexp.'/S', 'static::toBlankCallback', $string);
    }
    ...
    static function toBlankCallback($m) {
        if((!is_array($m)) || (!isset($m[1])) || (empty($m[1]))) {
            return $m[0];
        }
        else {
