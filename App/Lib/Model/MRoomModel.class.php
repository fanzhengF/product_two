...
class MRoomModel extends Model{
    ...
    public function getList($where, $firstRow = 0, $listRows = 20,$onlyCount=0,$type){
       ...
       /* if(!empty($where)){
        ...
        $fields = 'room_quyu,room_no,room_yx,room_jigou,room_id,room_name,room_address,room_facilities,room_number,room_shape,room_service,room_time';
