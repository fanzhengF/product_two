...
class ZichouAction extends AdminAction{
        ...
        if(IS_POST){
            try {
                ...
                if($data = $D->create(I('post.'))){
                    $re = $D->add($data);
                    if($re){
                        $this->success("添加成功",U("/Admin/Zichou/index"));
                        return ;
                    }else{
                ...
                $this->error($e->getMessage(),U("/Admin/Zichou/index"));
            }
        ...
        if(IS_POST){
            try {
                ...
                if($data = $D->create(I('post.'))){
                    ...
                    if($re){
                        $this->success("修改成功",U("/Admin/Zichou/index"));
                        return ;
                    }else{
    ...
    public function delete(){
        ...
        if($re){
            $this->success("删除成功",U("/Admin/Zichou/index"));
        }else{
            $this->error("删除失败",U("/Admin/Zichou/index"));
        }
    }
