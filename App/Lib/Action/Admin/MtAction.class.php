...
class MtAction extends AdminAction{
            ...
            try {
                ...
                if($data = $D->create(I('post.'))){
                 ...
                 //   echo $D->getLastSql();exit;
                    if($re){
                        $this->success("添加成功",U("/Admin/Mt/index"));
                        return ;
                    }else{
                ...
                $this->error($e->getMessage(),U("/Admin/Mt/index"));
            }
        ...
        if(IS_POST){
            try {
                ...
                if($data = $D->create(I('post.'))){
                    ...
                    //echo $D->getLastSql();exit;
                    if($re){
                        $this->success("修改成功",U("/Admin/Mt/index"));
                        return ;
                    }else{
    ...
    public function delete(){
        ...
        if($re){
            $this->success("删除成功",U("/Admin/Mt/index"));
        }else{
            $this->error("删除失败",U("/Admin/Mt/index"));
        }
    }
