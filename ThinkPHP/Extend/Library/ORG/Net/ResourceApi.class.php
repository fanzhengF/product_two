...
class ResourceApiHelper {
    ...
    static $furl = 'http://src.leju.com/';
    static $burl = 'http://photo.leju.com/';
    ...
    function get_base_front_url() {
        ...
        if (isset($_SERVER) && array_key_exists('HTTP_HOST', $_SERVER)) {
            ...
            if (strpos($dhost, 'test.') === 0) {
                $furl = "http://test.src.house.sina.com.cn/";
            }
        }*/

        return $furl . 'imp/imp/deal/';
    }
    ...
    function get_base_resouce_url() {
        ...
        if (isset($_SERVER) && array_key_exists('HTTP_HOST', $_SERVER)) {
            $dhost = $_SERVER['HTTP_HOST'];
            if (strpos($dhost, 'test.') === 0) {
                $burl = "http://test.photo.house.sina.com.cn/";
            }
        }*/
        return $burl;
    }
	 ...
	 * @access private
	 */
    function _curl_multipart_post($url, $post_data, $file_fields = array(), $timeout=60)
    {
       // print_r( $post_data);exit;
