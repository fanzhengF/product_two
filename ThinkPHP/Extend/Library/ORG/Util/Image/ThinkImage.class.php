...
// +----------------------------------------------------------------------
// | TOPThink [ WE CAN DO IT JUST THINK ] test
// +----------------------------------------------------------------------
...
define('THINKIMAGE_MAGICKWAND', 3); //常量，标识imagick库类型
...
define('THINKIMAGE_THUMB_FULL_1',    7); //常量，标识缩略图按短边缩小(保证完整原图)
define('THINKIMAGE_THUMB_FULL_2',    8); //常量，标识缩略图按长边缩小(保证完整原图)
